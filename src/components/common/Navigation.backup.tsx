                      ...
                      <Link
                        ...
                        className={`relative px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 group ${
                          activeSection === item.href.substring(1)
                            ...
                            : 'text-foreground/70 hover:text-foreground hover:bg-white/10 hover:scale-102'
                        }`}
                      >
                        {activeSection === item.href.substring(1) && (
                          <motion.div
                        ...
                        >
                          <Link
                            ...
                            className={`block py-4 px-6 rounded-2xl font-semibold transition-all duration-300 ${
                              activeSection === item.href.substring(1)
                                ? 'bg-gradient-primary text-white shadow-glow-lg scale-102'
                                : 'text-foreground/80 hover:text-foreground hover:bg-white/10 hover:scale-102'
                            }`}
                          >
                            {item.name}
                          </Link>
